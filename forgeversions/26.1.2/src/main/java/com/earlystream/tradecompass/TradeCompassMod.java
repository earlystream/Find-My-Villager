...
public final class TradeCompassMod {
    ...
    public TradeCompassMod() {
        RegisterKeyMappingsEvent.BUS.addListener(TradeCompassKeybinds::onRegisterKeyMappings);
    ...
    private static void onAddGuiOverlayLayers(AddGuiOverlayLayersEvent event) {
        event.getLayeredDraw().add(
            Identifier.fromNamespaceAndPath("tradecompass", "direction_hud"),
            TradeCompassTargetHudRenderer::extractRenderState
        );
    }
    ...
    public static void onClientTick(TickEvent.ClientTickEvent.Post event) {
        ...
        boolean rawOpenKeyDown = InputConstants.isKeyDown(client.getWindow(), GLFW.GLFW_KEY_V);
